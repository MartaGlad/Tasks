...
class TrelloClientTest {
    ...
    void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/1/members/test/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    void shouldCreateCard() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/1/cards?key=test&token=test&name=Test%20task&desc=Test%20task%20description&pos=top&idList=test_id");
